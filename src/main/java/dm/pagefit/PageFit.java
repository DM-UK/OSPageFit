...
public class PageFit
{
    ...
    public final static String ROUTE_FILENAME = "resources/route1.txt";

    // Path where the animation will be saved
    public final static String ANIMATION_FILENAME = "resources/animation1.gif";

    // Path to the file where cluster information will be saved
    public final static String CLUSTERS_FILENAME = "resources/route1clusters.txt";

    // Flag indicating whether to save the animation
    public boolean SAVE_ANIMATION = true;

    // Dimensions of the animation
    public final static int ANIMATION_WIDTH = 1200;
    public final static int ANIMATION_HEIGHT = 800;

    // Page size used for clustering
    public final static PageSize PAGE_SIZE = new PageSize.A3MapSize(25000);
